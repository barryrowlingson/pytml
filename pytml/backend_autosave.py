...
Copy this to backend_autosave.py and replace all instances of 'template'
with 'autosave'.  Then implement the class methods and functions below, and
add 'autosave' to the switchyard in matplotlib/backends/__init__.py and
'autosave' to the backends list in the validate_backend methon in
...
plotnumber = 0
lastfile = ""
filename_template = "plot-%s.png"
setdpi = None
setfigsize = None
outdir = "./"

class Rendererautosave(RendererBase):
    """
...
#         pass
    ...
    def new_gc(self):
        return GraphicsContextautosave()
...
class GraphicsContextautosave(GraphicsContextBase):
    """
...
def new_figure_manager_given_figure(num, figure):
    ...
    """
    canvas = FigureCanvasautosave(figure)
    manager = FigureManagerautosave(canvas, num)
    return manager


class FigureCanvasautosave(FigureCanvasBase):
    """
    ...
    def draw(self):
        ...
        """
        renderer = Rendererautosave(self.figure.dpi)
        self.figure.draw(renderer)

    # You should provide a print_autosave function for every file format
    # you can write.
...
class FigureManagerautosave(FigureManagerBase):
    """
...
FigureManager = FigureManagerautosave
